...
This is the list of proposed deliverables. All of them require multiple outputs and workstreams described on their respective files, this table provides only a short overview.

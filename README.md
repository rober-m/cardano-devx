...
| [Exploratory and Reactive](./deliverables/reactive.md) | Push for community agreement and resolution of key DevX and DeFi CIPs: standardization of CBOR objects, Account Address Enhancement (CIP-159), nested transactions (CIP-118), and programmable tokens (CIP-113). Propagate changes post-acceptance. Includes supporting Pentad integrations (Stablecoins, Bridges, Oracles).                                                                      | TODO                                                   | TODO                                                                                                       |
